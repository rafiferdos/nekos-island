...
const ErrorPage = () => {
    return (
        <section className="bg-white min-h-screen items-center flex">
            <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                <div className="mx-auto max-w-screen-sm text-center">
                    ...
                    <p className="mb-4 text-3xl tracking-tight font-bold text-gray-900 md:text-4xl ">Something is <span className="bg-gradient-to-r from-orange-400 to-red-800 text-transparent bg-clip-text animate-gradient bg-300%">missing.</span></p>
