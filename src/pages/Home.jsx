...
const Home = () => {
    ...
    return (
        <div className='container mx-auto w-11/12 max-w-7xl'>
            <Slider/>
            <h1 className='lg:text-5xl md:text-3xl text-xl text-center lg:my-16 md:my-10  font-bold'>Our <span
            ...
            <h1 className='lg:text-5xl md:text-3xl text-xl text-center lg:mt-8 md:my-3 my-2 font-bold'> Our <span className='font-madimi bg-gradient-to-r from-orange-700 via-blue-500 to-green-400 text-transparent bg-clip-text animate-gradient bg-300%'>Features</span>
            </h1>
            <Features/>
            <h1 className='lg:text-5xl md:text-3xl text-xl text-center lg:my-4 md:my-3 my-2 font-bold'>Contact <span
