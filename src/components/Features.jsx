                ...
                <div className="bg-gray-800 rounded-3xl dark:bg-gray-100 text-gray-100 dark:text-gray-800 shadow-2xl">
                    <div className="px-4 py-16 mx-auto max-w-7xl sm:px-6 lg:px-8">
                        <div className="max-w-3xl mx-auto text-center">
                            ...
                            <p className="mt-4 text-lg text-gray-400 dark:text-gray-600">We are pleased to introduce you
                        ...
                        <dl className="mt-12 space-y-10 sm:space-y-0 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:gap-y-12 lg:grid-cols-4 lg:gap-x-8">
                            <div className="flex">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                     ...
                                     className="flex-shrink-0 w-6 h-6 text-violet-400 dark:text-violet-600">
                            ...
                            <div className="flex">
                                ...
                                <div className="ml-3">
                                    ...
                                    <dd className="mt-2 text-gray-400 dark:text-gray-600">Make informed choices with
                            ...
                            <div className="flex">
                                ...
                                <div className="ml-3">
                                    ...
                                    <dd className="mt-2 text-gray-400 dark:text-gray-600">Save money and splurge on new
